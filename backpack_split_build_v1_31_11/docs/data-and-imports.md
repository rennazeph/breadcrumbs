# Data, Persistence, and Imports — Backpack 1.31.11
...
## Quick Notes link persistence note — v1.31.11

Quick Notes links are still stored per note in `note.links`, but the administration UI is now a board-level Links Inspector. This avoids storing any UI-only drawer state inside note geometry and keeps exported data stable across small-card recovery.
